...
<body>
    ...
    <div class="section" id="websites">
        ...
        <ul>
            <li><img onload="lzld(this)" data-src="visuals/websites/clp.jpg" src="visuals/websites/clp-pix.jpg" alt="Christian Lewis Photography"></li>
            <li><img onload="lzld(this)" data-src="visuals/websites/kaiwoshe.jpg" src="visuals/websites/kaiwoshe-pix.jpg" alt="Kaiwoshe Inn Guest House"></li>
            <li><img onload="lzld(this)" data-src="visuals/websites/wyw2.jpg" src="visuals/websites/wyw2-pix.jpg" alt="Write Your Will Limited"></li>
            <li><img onload="lzld(this)" data-src="visuals/websites/music-site.jpg" src="visuals/websites/music-site-pix.jpg" alt="JK Music site"></li>
            <li><img onload="lzld(this)" data-src="visuals/websites/uds.jpg" src="visuals/websites/uds-pix.jpg" alt="Université de Sherbrooke comminications site"></li>
            <li><img onload="lzld(this)" data-src="visuals/websites/jeetan.jpg" src="visuals/websites/jeetan-pix.jpg" alt="Jeetan Patel's professional home page"></li>
            <li><img onload="lzld(this)" data-src="visuals/websites/codeheads.jpg" src="visuals/websites/codeheads-pix.jpg" alt="Codeheads flash games"></li>
            <li><img onload="lzld(this)" data-src="visuals/websites/zizi_2012.jpg" src="visuals/websites/zizi_2012-pix.jpg" alt="Zizi Hair Salon"></li>
        </ul>
        <hr>
    </div>
    <!-- #3 Prototypes & other -->
    <div class="section" id="prototypes">
        ...
        <ul>
            <li><img onload="lzld(this)" data-src="visuals/concepts/a7.jpg" src="visuals/concepts/a7-pix.jpg" alt="A7 landing page live snapshot"></li>
            <li><img onload="lzld(this)" data-src="visuals/concepts/angry-young-rats.jpg" src="visuals/concepts/angry-young-rats-pix.jpg" alt="Angry Young Rats CSS3 design concept"></li>
            <li><img onload="lzld(this)" data-src="visuals/concepts/envidia.jpg" src="visuals/concepts/envidia-pix.jpg" alt="ENVIDIA Webware"></li>
            <li><img onload="lzld(this)" data-src="visuals/concepts/en.jpg" src="visuals/concepts/en-pix.jpg" alt="ENVIDIA Webware prototype"></li>
            <li><img onload="lzld(this)" data-src="visuals/concepts/je-rev2.jpg" src="visuals/concepts/je-rev2-pix.jpg" alt="Early Julien Etienne web design and development website"></li>
        </ul>
        <hr>
    </div>
    <!-- #4 Logos & branding -->
    <div class="section" id="logos-and-branding">
        <svg class="cross">
            <line x1="0" y1="0"/>
            <line x1="0" y2="0"/>
        </svg>
        ...
        <ul>
            <li><img onload="lzld(this)" data-src="visuals/landb/2.jpg" src="visuals/landb/2-pix.jpg" alt="Branding header image"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/zizi.gif" src="visuals/landb/zizi-pix.jpg" alt="Zizi Hair Salon logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/10.jpg" src="visuals/landb/10-pix.jpg" alt="Iris computers logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/8.jpg" src="visuals/landb/8-pix.jpg" alt="Vector Zip design symbolic logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/wyw_logo.jpg" src="visuals/landb/wyw-logo-pix.jpg" alt="Write Your Will logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/k-live.gif" src="visuals/landb/k-live-pix.jpg" alt="K Live Entertainment logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/11.jpg" src="visuals/landb/11-pix.jpg" alt="Apolo Technologies logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/15.jpg" src="visuals/landb/15-pix.jpg" alt="Resource & UK Live Events logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/17.jpg" src="visuals/landb/17-pix.jpg" alt="Play God logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/jw.png" src="visuals/landb/jw-pix.jpg" alt="Jo Woode logo"></li>
            <li><img onload="lzld(this)" data-src="visuals/landb/9.jpg" src="visuals/landb/9-pix.jpg" alt="Pharo & Go Digital logo"></li>
        </ul>
        <hr>
    </div>
    ...
    <div class="section" id="maya">
        ...
        <ul>
            <li><a target="_blank" href="visuals/alt/2.jpg">Rosso Diablo: Tiger Heads</a></li>
            <li><a target="_blank" href="visuals/alt/1.jpg">Wild Rapid Gaming Character</a></li>
            <li><a target="_blank" href="visuals/alt/3.jpg">SolaRay Logo symbol</a></li>
            <li><a target="_blank" href="visuals/alt/4.jpg">Sprite design for JavaScript game</a></li>
            <li><a target="_blank" href="visuals/alt/7.jpg">2nd World, art</a></li>
            <li><a target="_blank" href="visuals/alt/9.jpg">Automobile design prototype</a></li>
        </ul>
        <hr>
    </div>
    <!-- #6 APIs-->
    <div class="section" id="apis">
        ...
        <h2>APIs</h2>
        <ul>
            <li><a target="_blank" href="https://github.com/julienetie/soucouyant">Soucouyant</a></li>
            <li><a target="_blank" href="https://github.com/julienetie/resizilla">Resizilla</a></li>
            <li><a target="_blank" href="https://github.com/julienetie/cssesta-css-reset">CSSesta</a></li>
            <li>
